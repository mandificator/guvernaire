...
export const decizii: Decizie[] = [
  {
    ...
    controverse: [
      ...
      "Congresul PNL din 21 iunie a cerut formal demisia din partid a propriului premier desemnat (Veștea) și a altor patru lideri (Bode, Bogdan, Thuma, Gorghiu), sub sancțiunea excluderii — un partid care își dă afară, în bloc, oamenii pe care i-a propulsat în funcții și care îi reprezentaseră în conducere.",
      "Rezoluția anti-coaliție cu PSD adoptată de Congres prevede excludere automată pentru orice membru PNL care ar vota guvernul Veștea — o restricție de vot impusă prin statut de partid, care reintră în aceeași tensiune cu interdicția constituțională a mandatului imperativ invocată deja în instanță de tabăra pro-Veștea.",
    ],
    surse: [
      {
        titlu:
