...
export const config = {
  matcher: [
    ...
    "/((?!_next/|_vercel/|api/cod|poarta|ilustratii/|favicon\\.ico|icon\\.svg|icon-512\\.png|apple-icon\\.png|manifest\\.json|robots\\.txt|sitemap\\.xml|feed\\.xml|.*opengraph-image).*)",
  ],
};
